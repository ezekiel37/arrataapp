...
//                <Link className="nav-link" to="upload.html">
...
//         <Dropdown.Menu>
//           <Dropdown.Item href="#">
//           <Link className="dropdown-item" to="account.html"><FontAwesomeIcon className="fa-fw" icon={faUserCircle} /> &nbsp; My Account</Link>
//           </Dropdown.Item>
//           <Dropdown.Item href="#">
//           <Link className="dropdown-item" to="subscriptions.html"><FontAwesomeIcon className="fa-fw" icon={faVideo} /> &nbsp; Subscriptions</Link>
//           </Dropdown.Item>
//           <Dropdown.Item href="#">
//           <Link className="dropdown-item" to="settings.html"><FontAwesomeIcon className="fa-fw" icon={faCog} /> &nbsp; Settings</Link>
//           </Dropdown.Item>
//           <div className="dropdown-divider"></div>
//           <Dropdown.Item href="#">
...
//                <Link className="nav-link" to="channels.html">
//                <FontAwesomeIcon className="fa-fw" icon={faUser} />
//                <span>Channels</span>
//                </Link>
//             </li>
//             <li className="nav-item">
//                <Link className="nav-link" to="single-channel.html">
//                <FontAwesomeIcon className="fa-fw" icon={faUserAlt} />
//                <span>Single Channel</span>
//                </Link>
//             </li>
//             <li className="nav-item">
//                <Link className="nav-link" to="video-page.html">
...
//           </Dropdown.Item>
//           <Dropdown.Item href="#">
//           <Link className="dropdown-item" to="blog-detail.html">Blog Detail</Link>
//           </Dropdown.Item>
//           <Dropdown.Item href="#">
