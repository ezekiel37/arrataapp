                     ...
                     <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="channels-card">
                           <div className="channels-card-image">
                              ...
                              <div className="channels-card-image-btn"><button type="button" className="btn btn-success btn-sm border-none">Subscribe <strong>1.4M</strong></button> <button type="button" className="btn btn-warning btn-sm border-none"><i className="fas fa-times-circle"></i></button></div>
                           </div>
                     ...
                     <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="channels-card">
                           <div className="channels-card-image">
                              ...
                              <div className="channels-card-image-btn"><button type="button" className="btn btn-danger btn-sm border-none">Subscribe <strong>1.4M</strong></button> <button type="button" className="btn btn-warning btn-sm border-none"><i className="fas fa-times-circle"></i></button></div>
                           </div>
                           <div className="channels-card-body">
                              <div className="channels-title">
                     ...
                     <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="channels-card">
                           <div className="channels-card-image">
                              ...
                              <div className="channels-card-image-btn"><button type="button" className="btn btn-secondary btn-sm border-none">Subscribed <strong>1.4M</strong></button> <button type="button" className="btn btn-warning btn-sm border-none"><i className="fas fa-times-circle"></i></button></div>
                           </div>
                           <div className="channels-card-body">
                              <div className="channels-title">
